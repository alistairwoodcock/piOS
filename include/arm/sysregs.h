...
#define SCTLR_EL1_EOE_LITTLE_ENDIAN         (0 << 24)
#define SCTLR_EL1_I_CACHE_DISABLED          (0 << 12)
#define SCTLR_EL1_C_CACHE_DISABLED          (0 << 2)
#define SCTLR_EL1_MMU_DISABLED              (0 << 0)
#define SCTLR_EL1_MMU_ENABLED               (1 << 0)


#define SCTLR_EL2_VALUE_MMU_DISABLED        (SCTLR_EL1_RESERVED | SCTLR_EL1_EE_LITTLE_ENDIAN | SCTLR_EL1_EOE_LITTLE_ENDIAN | SCTLR_EL1_I_CACHE_DISABLED | SCTLR_EL1_C_CACHE_DISABLED | SCTLR_EL1_MMU_DISABLED)
